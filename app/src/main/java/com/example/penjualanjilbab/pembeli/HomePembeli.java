...
import com.example.penjualanjilbab.admin.ActivityDataJilbab;
import com.example.penjualanjilbab.admin.EditJilbabDanHapusActivity;
...
public class HomePembeli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterHijab(HomePembeli.this, newsList);
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(HomePembeli.this, DetailJilbab.class);
